// fix-carte-leaflet-longpress-v2.js
...
//   node fix-carte-leaflet-longpress-v2.js
...
const boutonEnregistrer = "d" + String.fromCharCode(39) + "enregistrer";
const messageErreur = "rien n" + String.fromCharCode(39) + "a ete sauvegarde pour eviter un fichier a moitie modifie.";
...
'  menu.innerHTML =',
'    "<div style=" + String.fromCharCode(34) + "padding:9px 14px;font-size:11px;font-weight:800;color:#6b7280;border-bottom:1px solid #e4e7ec" + String.fromCharCode(34) + ">" + latlng.lat.toFixed(5) + ", " + latlng.lng.toFixed(5) + "</div>"',
'    + "<div style=" + String.fromCharCode(34) + "padding:12px 14px;font-size:13px;font-weight:700;cursor:pointer" + String.fromCharCode(34) + " onclick=" + String.fromCharCode(34) + "lpmNaviguer(" + latlng.lat + "," + latlng.lng + ")" + String.fromCharCode(34) + ">Naviguer</div>"',
'    + "<div style=" + String.fromCharCode(34) + "padding:12px 14px;font-size:13px;font-weight:700;cursor:pointer;border-top:1px solid #e4e7ec" + String.fromCharCode(34) + " onclick=" + String.fromCharCode(34) + "lpmEnregistrer(" + latlng.lat + "," + latlng.lng + ")" + String.fromCharCode(34) + ">Enregistrer</div>"',
'    + "<div style=" + String.fromCharCode(34) + "padding:12px 14px;font-size:13px;font-weight:700;cursor:pointer;border-top:1px solid #e4e7ec" + String.fromCharCode(34) + " onclick=" + String.fromCharCode(34) + "lpmPartager(" + latlng.lat + "," + latlng.lng + ")" + String.fromCharCode(34) + ">Partager</div>";',
...
'  }catch(e){',
'    showToast("Erreur : impossible d" + String.fromCharCode(39) + "enregistrer");',
'  }',
'  closeLongPressMenu();',
'}',
